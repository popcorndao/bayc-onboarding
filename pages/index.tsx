                  ...
                  {submitSuccess ? (
                    <div>
                      ...
                      <p className="text-xl 2xl:text-3xl text-gray-900 font-light text-center mt-2">
                        You are in! We will send you an email in a few days once
                        the airdrop is ready.
                      </p>
                    </div>
                  ) : (
                    <div>
                    ...
                    >
                      <p
                        className={`text-lg xl:text-xl 2xl:text-2xl font-semibold ${
                          step === Step.Wallet ? "text-gray-500" : "text-black"
                        }`}
                      >
                        2
                      </p>
                              ...
                              <input
                                ...
                                onClick={() => {
                                  if (email.length > 0 && !emailError) {
                                    if (
                                      registeredContacts.emails.includes(email)
                                    ) {
                                      router.push("/alreadyRegistered");
                                    } else {
                                      addApe();
